...
export async function POST(req: NextRequest) {
  try {
    ...
    // 2. Send emails via SMTP (if configured)
      ...
      const adminHtml = `
        <div style="font-family:Arial,sans-serif;max-width:620px;margin:0 auto;">
          ...
          <div style="background:#f0f0f0;padding:14px;text-align:center;">
            <p style="color:#888;font-size:12px;margin:0;">IIA Telangana Chapter · Telangana Architecture Festival 2026</p>
          </div>
        </div>`;
        ...
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
          ...
          <div style="background:#fff;padding:36px;">
            ...
            <p style="color:#555;line-height:1.75;font-size:14px;">
              Thank you for registering for the <strong>Telangana Architecture Festival 2026</strong>. We have received your registration and payment screenshot.
              Our team will verify your payment within <strong>24 hours</strong> and send you a final confirmation.
            </p>
