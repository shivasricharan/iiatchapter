    ...
    <main style={{ minHeight: "100vh", background: "#0f2060", color: "#f0ede6", padding: "6rem 1.75rem 4rem" }}>
      <div style={{ maxWidth: 820, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "2rem", marginBottom: "3rem" }}>
          {policyBlocks.map(({ heading, body }) => (
            <div key={heading} style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(201,162,39,0.15)", borderRadius: 12, padding: "1.75rem" }}>
              <h2 style={{ fontFamily: "var(--font-playfair,Georgia,serif)", fontSize: "1.05rem", color: "#c9a227", margin: "0 0 0.9rem", fontWeight: 600 }}>
                {heading}
              </h2>
              <p style={{ fontSize: "0.88rem", lineHeight: 1.9, color: "rgba(240,237,230,0.68)", margin: 0 }}>
                {body}
              </p>
            </div>
          ))}
        ...
        {/* Grievance Officer */}
        <div style={{ background: "rgba(201,162,39,0.07)", border: "1px solid rgba(201,162,39,0.3)", borderRadius: 12, padding: "1.75rem", marginBottom: "2rem" }}>
          <h2 style={{ fontFamily: "var(--font-playfair,Georgia,serif)", fontSize: "1.05rem", color: "#c9a227", margin: "0 0 1rem", fontWeight: 600 }}>
            Grievance Officer
          </h2>
          <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem", fontSize: "0.87rem", color: "rgba(240,237,230,0.65)" }}>
            <p style={{ margin: 0 }}>Indian Institute of Architects, Telangana Chapter</p>
            <p style={{ margin: 0 }}>802C Al Karim Trade Centre, MG Road, Ranigunj, Secunderabad, Telangana 500003</p>
            <p style={{ margin: 0 }}>
              Email:{" "}
